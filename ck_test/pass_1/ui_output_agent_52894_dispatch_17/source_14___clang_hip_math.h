...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
float __fmaf_rd(float __x, float __y, float __z) { return __ocml_fma_rtn_f32(__x, __y, __z); }
__DEVICE__
float __fmaf_rn(float __x, float __y, float __z) { return __ocml_fma_rte_f32(__x, __y, __z); }
__DEVICE__
float __fmaf_ru(float __x, float __y, float __z) { return __ocml_fma_rtp_f32(__x, __y, __z); }
__DEVICE__
float __fmaf_rz(float __x, float __y, float __z) { return __ocml_fma_rtz_f32(__x, __y, __z); }
#else
__DEVICE__
float __fmaf_rn(float __x, float __y, float __z) { return __builtin_fmaf(__x, __y, __z); }
#endif
...
__DEVICE__
float __tanf(float __x) { return __sinf(__x) * __builtin_amdgcn_rcpf(__cosf(__x)); }
// END INTRINSICS
...
__DEVICE__
float norm3df(float __x, float __y, float __z) { return __ocml_len3_f32(__x, __y, __z); }
...
__DEVICE_NOCE__
float normf(int __dim, const float* __a)
...
__DEVICE__
float rnorm3df(float __x, float __y, float __z) { return __ocml_rlen3_f32(__x, __y, __z); }
...
__DEVICE_NOCE__
float rnormf(int __dim, const float* __a)
{ // TODO: placeholder until OCML adds support.
    float __r = 0;
    while(__dim--)
    {
...
{
    return (__n < INT_MAX) ? __builtin_amdgcn_ldexpf(__x, __n) : __ocml_scalb_f32(__x, __n);
}
...
__DEVICE__
double nextafter(double __x, double __y) { return __ocml_nextafter_f64(__x, __y); }

__DEVICE_NOCE__
double norm(int __dim, const double* __a)
{ // TODO: placeholder until OCML adds support.
    double __r = 0;
    while(__dim--)
    {
...
__DEVICE__
double norm3d(double __x, double __y, double __z) { return __ocml_len3_f64(__x, __y, __z); }
...
__DEVICE_NOCE__
double rnorm(int __dim, const double* __a)
{ // TODO: placeholder until OCML adds support.
    double __r = 0;
    while(__dim--)
    {
...
__DEVICE__
double rnorm3d(double __x, double __y, double __z) { return __ocml_rlen3_f64(__x, __y, __z); }
...
{
    return (__n < INT_MAX) ? __builtin_amdgcn_ldexp(__x, __n) : __ocml_scalb_f64(__x, __n);
}
__DEVICE__
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __dadd_rd(double __x, double __y) { return __ocml_add_rtn_f64(__x, __y); }
__DEVICE__
double __dadd_rn(double __x, double __y) { return __ocml_add_rte_f64(__x, __y); }
__DEVICE__
double __dadd_ru(double __x, double __y) { return __ocml_add_rtp_f64(__x, __y); }
__DEVICE__
double __dadd_rz(double __x, double __y) { return __ocml_add_rtz_f64(__x, __y); }
#else
__DEVICE__
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __ddiv_rd(double __x, double __y) { return __ocml_div_rtn_f64(__x, __y); }
__DEVICE__
double __ddiv_rn(double __x, double __y) { return __ocml_div_rte_f64(__x, __y); }
__DEVICE__
double __ddiv_ru(double __x, double __y) { return __ocml_div_rtp_f64(__x, __y); }
__DEVICE__
double __ddiv_rz(double __x, double __y) { return __ocml_div_rtz_f64(__x, __y); }
#else
__DEVICE__
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __dmul_rd(double __x, double __y) { return __ocml_mul_rtn_f64(__x, __y); }
__DEVICE__
double __dmul_rn(double __x, double __y) { return __ocml_mul_rte_f64(__x, __y); }
__DEVICE__
double __dmul_ru(double __x, double __y) { return __ocml_mul_rtp_f64(__x, __y); }
__DEVICE__
double __dmul_rz(double __x, double __y) { return __ocml_mul_rtz_f64(__x, __y); }
#else
__DEVICE__
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __dsub_rd(double __x, double __y) { return __ocml_sub_rtn_f64(__x, __y); }
__DEVICE__
double __dsub_rn(double __x, double __y) { return __ocml_sub_rte_f64(__x, __y); }
__DEVICE__
double __dsub_ru(double __x, double __y) { return __ocml_sub_rtp_f64(__x, __y); }
__DEVICE__
double __dsub_rz(double __x, double __y) { return __ocml_sub_rtz_f64(__x, __y); }
#else
__DEVICE__
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __fma_rd(double __x, double __y, double __z) { return __ocml_fma_rtn_f64(__x, __y, __z); }
__DEVICE__
double __fma_rn(double __x, double __y, double __z) { return __ocml_fma_rte_f64(__x, __y, __z); }
__DEVICE__
double __fma_ru(double __x, double __y, double __z) { return __ocml_fma_rtp_f64(__x, __y, __z); }
__DEVICE__
double __fma_rz(double __x, double __y, double __z) { return __ocml_fma_rtz_f64(__x, __y, __z); }
#else
__DEVICE__
double __fma_rn(double __x, double __y, double __z) { return __builtin_fma(__x, __y, __z); }
#endif
// END INTRINSICS
// END DOUBLE
...
__DEVICE__ int min(int __arg1, int __arg2) { return (__arg1 < __arg2) ? __arg1 : __arg2; }
__DEVICE__ int max(int __arg1, int __arg2) { return (__arg1 > __arg2) ? __arg1 : __arg2; }
...
__host__ inline static int min(int __arg1, int __arg2) { return __arg1 < __arg2 ? __arg1 : __arg2; }

__host__ inline static int max(int __arg1, int __arg2) { return __arg1 > __arg2 ? __arg1 : __arg2; }
