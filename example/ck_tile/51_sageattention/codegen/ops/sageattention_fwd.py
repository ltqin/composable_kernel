...
using trait = sageattn_fwd_traits_<{F_hdim}, {F_dtype}, {F_mode},{F_bm0}, {F_bn0}, {F_bk0}, {F_bn1}, {F_bk1}, {F_bk0max}, {F_vlayout},
                        {F_pipeline_enum}, fmha_mask, {F_bias}, {F_lse}, {F_qscale}, {F_spad}, {F_skpad}, {F_dpad}, {F_dvpad}, {F_trload}, {F_skip}>;
...
SAGEATTN_FWD_API_INNER_DISPATCH = """{F_if}((t.is_group_mode == {F_mode}) && (t.is_v_rowmajor == {F_vlayout}) && ({F_mask_check}) && (t.bias_type == {F_bias_check}) && (t.has_lse == {F_lse}) && (t.qscale_type == {F_qscale_check}) && (t.skip_min_seqlen_q == {F_skip}) &&
        ({F_scheck}) && ({F_seqtune}) && ({F_skcheck}) && ({F_dcheck}) && ({F_dvcheck}) && ({F_constraint})) {{
    using trait_ = sageattn_fwd_traits_<{F_hdim}, {F_dtype}, {F_mode}, {F_bm0}, {F_bn0}, {F_bk0}, {F_bn1}, {F_bk1}, {F_bk0max}, {F_vlayout}, {F_pipeline_enum}, {F_mask}, {F_bias}, {F_lse}, {F_qscale}, {F_spad}, {F_skpad}, {F_dpad}, {F_dvpad}, {F_trload}, {F_skip}>;
...
class SageAttnFwdApiTrait:
    ...
    def name(self) -> str:
        return (
            ...
            + f"{self.vlayout}-{self.mask}-{self.bias}-{self.lse}-{self.qscale}-{self.spad}-{self.skpad}-{self.dpad}-{self.dvpad}-{self.skip}"
        )
...
class KernelComponentFactoryGfx9(CompatibilityRuleFactoryGfx9):
    ...
    def get_hdim_tile_size_dict(cls, dtype: str) -> Optional[dict]:
        if dtype in cls._DT_FP32:
            return {
                #                             bm0, bn0, bk0, bn1, bk1,
                ( 32,  32) : [SageAttnFwdTileSize( 64,  64,  16,  32,  32,  32,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                ( 48,  48) : [SageAttnFwdTileSize( 32, 128,  16,  48,  16,  48,  2, 1, 1,  2, 1, 1,  16, 16, 16,  16, 16, 16,  -1),
                              SageAttnFwdTileSize(128,  64,  16,  48,  32,  48,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                ( 64,  64) : [SageAttnFwdTileSize( 64,  64,  32,  64,  32,  64,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                ( 96, 128) : [SageAttnFwdTileSize(128,  64,  32, 128,  32,  96,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                (128, 128) : [SageAttnFwdTileSize( 32, 128,  32, 128,  16, 128,  2, 1, 1,  2, 1, 1,  16, 16, 16,  16, 16, 16,  -1),
                              SageAttnFwdTileSize(128,  64,  32, 128,  32, 128,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                (192, 192) : [SageAttnFwdTileSize( 64,  64,  32, 192,  32, 192,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                (256, 256) : [SageAttnFwdTileSize( 64,  64,  32, 256,  32, 256,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
            }  # fmt: skip
        elif dtype in cls._DT_FP16_BF16:
            return {
                ( 32,  32) : [SageAttnFwdTileSize(128,  64,  16,  32,  32,  32,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],
                ...
                ( 80, 96)  : [SageAttnFwdTileSize(128, 128,  16,  96,  32,  80,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],
                ( 96, 128) : [SageAttnFwdTileSize(128, 128,  32, 128,  32,  96,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],
              ...
              # (160, 160) : [SageAttnFwdTileSize(128, 128 , 32, 160,  32, 160,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,   1)],
                (192, 128) : [SageAttnFwdTileSize(128, 128,  32, 128,  32, 192,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],
                (192, 192) : [SageAttnFwdTileSize(128, 128,  32, 192,  32, 192,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,   1)],
                (256, 256) : [SageAttnFwdTileSize(128, 128,  32, 256,  32, 256,  4, 1, 1,  4, 1, 1,  32, 32, 16,  32, 32, 16,  -1)],
            }  # fmt: skip
            ...
            return {
                ...
                (192, 128) : [SageAttnFwdTileSize(128, 128,  32, 128,  32, 192,  4, 1, 1,  4, 1, 1,  32, 32, 32,  32, 32, 32,  -1)],
                (256, 256) : [SageAttnFwdTileSize(128, 128,  32, 256,  32, 256,  4, 1, 1,  4, 1, 1,  32, 32, 32,  32, 32, 32,  -1)],
            }  # fmt: skip
    ...
    def get_pipelines(
        ...
        if dtype in cls._DT_FP32:
            ...
            for mask, bias in itertools.product(
                ...
                pipelines.append(SageAttnFwdPipeline("qr", "row", "f", "f", "f", "f", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                pipelines.append(SageAttnFwdPipeline("qr", "row", "f", "t", "f", "f", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
        elif dtype in cls._DT_FP16_BF16:
            qscale = "no"
            lse = "f"  # lse: only false
            skip = "f"  # skip: only false
            for mask, bias in itertools.product(
                ...
                if hdim == 256 and hdim_v == 256:
                    ...
                    pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "t", "f", "f", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                    pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                else:
                    if bias == "bias":
                        ...
                        pipelines.append(SageAttnFwdPipeline("qr_async", "row", "t", "f", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                        pipelines.append(SageAttnFwdPipeline("qr_async", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                    if receipt == 1 and bias != "bias":
                        pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip # TODO: cover arbitraty hdim# fmt: skip
            ...
            for mask, qscale in itertools.product(
                ...
                if hdim == 64:
                    pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "f", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                    pipelines.append(SageAttnFwdPipeline("qr", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                else:
                    pipelines.append(SageAttnFwdPipeline("qr_async", "row", "t", "f", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
                    pipelines.append(SageAttnFwdPipeline("qr_async", "row", "t", "t", "t", "t", bias, lse, qscale, mask, skip, "f"))  # fmt: skip
    ...
    def get_hdim_tile_size_dict(cls, dtype: str) -> Optional[dict]:
        if dtype in cls._DT_FP16_BF16:
            return {
                ...
                (192, 128) : [SageAttnFwdTileSize( 64,  64,  32, 128,  32,  256,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                (256, 256) : [SageAttnFwdTileSize( 64,  64,  32, 256,  32,  256,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
            }  # fmt: skip
            ...
            return {
                ...
                (128, 128) : [SageAttnFwdTileSize( 64,  64,  32, 128,  32,  128,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
                (256, 256) : [SageAttnFwdTileSize( 64,  32,  32, 256,  32,  256,  4, 1, 1,  4, 1, 1,  16, 16, 16,  16, 16, 16,  -1)],
            }  # fmt: skip
        elif dtype in cls._DT_FP8FP32:
            return {
                #                             bm0, bn0, bk0, bn1, bk1,
